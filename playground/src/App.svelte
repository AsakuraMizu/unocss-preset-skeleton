...
<AppShell>
  <svelte:fragment slot="header">
    ...
    <AppBar>
      ...
      <svelte:fragment slot="trail">
        <LightSwitch />
        <a
          class="btn-sm variant-ghost-surface btn"
  ...
  <div class="mx-auto h-full flex items-center justify-center container">
...
<style>
  figure {
    --at-apply: flex relative flex-col;
  }
  figure svg,
  .img-bg {
    --at-apply: 'w-64 h-64 md:w-80 md:h-80';
  }
  .img-bg {
    --at-apply: absolute z--1 rounded-full blur-50 transition-all;
    animation:
  ...
  @keyframes glow {
    0% {
      --at-apply: bg-primary-400/50;
    }
    33% {
      --at-apply: bg-secondary-400/50;
    }
    66% {
      --at-apply: bg-tertiary-400/50;
    }
    100% {
      --at-apply: bg-primary-400/50;
    }
