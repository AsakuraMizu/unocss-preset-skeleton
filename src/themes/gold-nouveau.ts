...
const goldNouveau: SkeletonTheme = {
  name: 'gold-nouveau',
  properties: {
  ...
  enhancements: {
    '[data-theme="gold-nouveau"] h1,[data-theme="gold-nouveau"] h2,[data-theme="gold-nouveau"] h3,[data-theme="gold-nouveau"] h4,[data-theme="gold-nouveau"] h5,[data-theme="gold-nouveau"] h6':
      { 'font-weight': 'bold' },
    '[data-theme="gold-nouveau"]': {
      'background-image':
        'radial-gradient(at 0% 100%, rgba(var(--color-secondary-500), 0.33) 0px, transparent 50%),radial-gradient(at 98% 100%, rgba(var(--color-error-500), 0.33) 0px, transparent 50%)',
