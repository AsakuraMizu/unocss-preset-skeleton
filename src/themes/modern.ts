...
const modern: SkeletonTheme = {
  ...
  enhancements: {
    '[data-theme="modern"] h1,[data-theme="modern"] h2,[data-theme="modern"] h3,[data-theme="modern"] h4,[data-theme="modern"] h5,[data-theme="modern"] h6,[data-theme="modern"] a,[data-theme="modern"] button':
      { 'font-weight': 'bold' },
    '[data-theme="modern"]': {
      'background-image':
    ...
    '.dark [data-theme="modern"]': {
      'background-image':
        'radial-gradient(at 76% 0%, hsla(189,100%,56%,0.20) 0px, transparent 50%),radial-gradient(at 1% 0%, hsla(340,100%,76%,0.15) 0px, transparent 50%),radial-gradient(at 20% 100%, hsla(241,100%,70%,0.30) 0px, transparent 50%)',
      'background-attachment': 'fixed',
      'background-position': 'center',
      'background-repeat': 'no-repeat',
      'background-size': 'cover',
