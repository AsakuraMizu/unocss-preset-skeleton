...
const vintage: SkeletonTheme = {
  ...
  enhancements: {
    '[data-theme="vintage"] h1,[data-theme="vintage"] h2,[data-theme="vintage"] h3,[data-theme="vintage"] h4,[data-theme="vintage"] h5,[data-theme="vintage"] h6':
      { 'letter-spacing': '1px' },
    '[data-theme="vintage"]': {
      'background-image':
        'radial-gradient(at 100% 0%, hsla(135,34%,70%,0.20) 0px, transparent 50%), radial-gradient(at 85% 100%, hsla(31,83%,50%,0.20) 0px, transparent 50%)',
    ...
    '.dark [data-theme="vintage"]': {
      'background-image':
        'radial-gradient(at 100% 0%, hsla(135,34%,70%,0.14) 0px, transparent 50%), radial-gradient(at 85% 100%, hsla(31,83%,50%,0.14) 0px, transparent 50%)',
      'background-attachment': 'fixed',
      'background-position': 'center',
      'background-repeat': 'no-repeat',
      'background-size': 'cover',
