import type { CSSEntries, CSSObject } from '@unocss/core';
import type { PresetThemeName, ThemeProperties } from './themes';
...
export interface ThemeOptions {
   ...
   *
   */
  preset?: (PresetThemeConfig | PresetThemeName)[];
}
...
export interface SkeletonTheme {
  ...
  enhancements?: string | Record<string, string | CSSEntries | CSSObject>;
}
